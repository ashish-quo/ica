...
var chart = new Highcharts.Chart({
    ...
    xAxis: {
        categories: ['Den', 'Gre', 'Fra', 'Belg', 'GR', 'Mali', 'L', 'Egy', '', '', '', '']
    },
...
$j('#roamer-chart').click(function(){
   if($j("#roamer-chart").prop('checked') == true){
   ...
   else if($j("#roamer-chart").prop('checked') == false){
...
$j('#mo-chart').click(function(){
   if($j("#mo-chart").prop('checked') == true){
	      var no = 2; //third element
    var data = [];
   ...
   else if($j("#mo-chart").prop('checked') == false){	
...
$j('#mt-chart').click(function(){
   if($j("#mt-chart").prop('checked') == true){
	    var no = 2; //third element
    var data = [];
   ...
   else if($j("#mt-chart").prop('checked') == false){
...
$j('#data-chart').click(function(){
   if($j("#data-chart").prop('checked') == true){
	    var no = 2; //third element
    var data = [];
   ...
   else if($j("#data-chart").prop('checked') == false){
