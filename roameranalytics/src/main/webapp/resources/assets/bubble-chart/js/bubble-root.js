...
$j(function() {
  ...
  displayRoamer = function(data) {
	...
	displayData = function(data) {
		return plotData("#vis4", data, plot);
	};

	displaySms = function(data) {
		return plotData("#vis4", data, plot);
	};
  ...
  d3.select("#jitter").on("input", function() {
    ...
    plotMo.jitter(parseFloat(this.output.value));
    plotMt.jitter(parseFloat(this.output.value));
  });
  ...
  d3.json('./getBubbleChartJson?data=[{"name":"Angola","count":2},{"name":"France","count":2},{"name":"Delhi","count":2}]', displayRoamer);
  d3.json('./getBubbleChartJson?data=[{"name":"Angola","count":2},{"name":"France","count":2},{"name":"Delhi","count":2}]', displayMo);
  d3.json('./getBubbleChartJson?data=[{"name":"Angola","count":2},{"name":"France","count":2},{"name":"Delhi","count":2}]', displayMt);
  d3.json('./getBubbleChartJson?data=[{"name":"Angola","count":2},{"name":"France","count":2},{"name":"Delhi","count":2}]', displayData);
