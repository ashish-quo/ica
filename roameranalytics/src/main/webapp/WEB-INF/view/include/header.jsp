...
<header class="clearfix">
  <div class="header-left clearfix">
    ...
    <a href ng-click="showHome()" class="logo" style=""><img src="images/logo.png" class="logo-img" alt="logo"><img src="images/responsive/rlogo.png" class="res-logo" alt="logo"><b id="logolable" style="display:none">{{roamType}}</b></a>
    <div class="top-nav">
      <ul>
        <li>
